<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    <symbol id="check-lg" xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
        class="bi bi-check-lg" viewBox="0 0 16 16">
        <path
            d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425z" />
    </symbol>
    <symbol id="circle-half" xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
        class="bi bi-circle-half" viewBox="0 0 16 16">
        <path d="M8 15A7 7 0 1 0 8 1zm0 1A8 8 0 1 1 8 0a8 8 0 0 1 0 16" />
    </symbol>
    <symbol id="moon-stars-fill" xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
    ...
    <symbol id="sun-fill" xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
...
<div class="dropdown position-fixed bottom-0 end-0 mb-1 me-1 bd-mode-toggle z-1">
    <button class="btn btn-sm btn-bd-primary d-flex align-items-center rounded-pill" id="bd-theme" aria-expanded="false"
        ...
        </svg><i class="bi bi-caret-up-fill ms-2"></i>
